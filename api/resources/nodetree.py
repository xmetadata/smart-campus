...
from models.nodetree import NodeTree, ListSchema, NodeSchema
    ...
    def post(self, node_uuid):
        ...
        if load_data['is_student']:
            ...
            for ite in patriarch_list:
                ...
                new_admin.students = [new_node, ]
                try:
                    new_admin.add(new_admin)
                except SQLAlchemyError as e:
                    patriarch_error.append(ite)
            if patriarch_error is False:
                return ret_msg(status=False, msg="add some patriarches failed.", data=json.dumps(patriarch_error))
