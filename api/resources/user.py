...
from models.user import UserModel, UserSchema, UserOut
...
class UserList(Resource):
    def post(self):
        ...
        try:
            load_data, errors = UserSchema().loads(json_data)
            if errors:
                return errors, 400
        ...
        return UserOut().dump(new_user), 201
...
class UserDetail(Resource):
    ...
    def get(self, id):
        ...
        dump_user, errors = UserOut().dump(user_detail)
